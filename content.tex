...
\end{itemize}
Calcium nitrate is used in addition, but for substrate buffering before planting rather than as a routine component of the nutrient solution (Section~\ref{sec:cultivation-technology}, Substrate Cultivation). \ph{Not yet documented: the exact stock-solution recipe, the split between the A and B tanks, target EC and pH values, and how the recipe is adjusted across the season. Recommended as a follow-up question with the company.}
